    ...
    const features = [
        {
            ...
            description: "Accédez à une vaste collection d'exercices de mathématiques de niveau post-bac,  organisés par thèmes.",
            icon: "bi-database"
        },
        {
            title: "Mode Vidéoprojecteur",
            description: "Affichez les exercices en grand format, parfait pour une utilisation en amphithéâtre ou en classe.",
            icon: "bi-display"
        },
        {
        ...
        },
        {
            ...
            description: "Trouvez rapidement les exercices pertinents grâce à notre moteur de recherche intelligent.",
            icon: "bi-search"
        }
    ];
