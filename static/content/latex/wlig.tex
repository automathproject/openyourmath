...
\item 
\question{
On définit la forme quadratique $Q(u,v)$ associé au Lagrangien par 
$Q(u,v)= \frac{1}{2} \begin{pmatrix} u & v\end{pmatrix} ~ H_L~ \begin{pmatrix} u \\ v\end{pmatrix}$ où $H_L$ est la Hessienne associée à la fonction $L$, c’est-à-dire:  
